...
document.addEventListener("DOMContentLoaded",function(e){gsap.registerPlugin(ScrollTrigger),gsap.registerPlugin(SplitText),gsap.registerPlugin(ScrambleTextPlugin),gsap.registerPlugin(DrawSVGPlugin);var t=gsap.timeline(),r=new SplitText("h1",{type:"words, chars"}),o=new SplitText(".welcome__time p",{type:"words"}),r=r.chars,o=o.words,r=(t.from(r,{duration:.8,opacity:0,scale:0,y:80,rotationX:180,transformOrigin:"0% 50% -50%",ease:"back",stagger:.15}),t.from(".photo_right",{duration:1,opacity:0,rotate:0,x:"50%",y:"-5%"},"<.5"),t.from(".photo_left",{duration:1.2,opacity:0,rotate:-20,y:"-20vh"},"<.5"),t.from(".photo_bottom",{duration:1,opacity:0,rotate:0,y:"20vh",x:"50%"},"<.5"),t.from(o,{duration:.8,opacity:0,scaleY:0,transformOrigin:"top",ease:"back",stagger:.2}),t.from(".welcome__time time",{duration:1.2,opacity:0,scale:0,transformOrigin:"bottom center",ease:"back.out(1.7)"}),t.from(".welcome__more",{duration:1,opacity:0}),Array.from(document.querySelectorAll(".star")));gsap.set(r,{transformOrigin:"center center",scale:0}),r.forEach((e,t)=>{t=gsap.timeline({repeat:-1,repeatDelay:gsap.utils.random(.5,2),delay:gsap.utils.random(.1,1)*t});t.set(e,{scale:0}),t.to(e,{scale:1}),t.to(e,{duration:1,scale:gsap.utils.random(1.1,1.5)}),t.to(e,{duration:.3,scale:0})});gsap.timeline().to(".welcome__arrow",{repeat:-1,y:-10,yoyo:!0});o=new SplitText(".wait__wrapper h2",{type:"words, chars"}),o.chars,t=o.words,r=gsap.timeline(),r.from(t,{duration:.8,opacity:0,y:"-100%",transformOrigin:"bottom center",ease:"back",stagger:.15}),r.from(".wait__wrapper p",{y:"50%",opacity:0}),ScrollTrigger.create({trigger:".wait__wrapper",start:"top 80%",end:"top center",scrub:!0,animation:r}),o=gsap.timeline(),t=document.querySelector(".when__content"),r=document.querySelector(".when__visual"),o.from(t,{x:"100%",opacity:0}),o.from(r,{rotate:720,scale:0,opacity:0},"<"),ScrollTrigger.create({trigger:".when__content",start:"top 80%",end:"center center",scrub:!0,animation:o}),t=gsap.timeline(),r=document.querySelector(".where__content"),o=document.querySelector(".where__visual"),t.from(r,{x:"-100%",opacity:0}),t.from(o,{rotate:720,scale:0,opacity:0},"<"),ScrollTrigger.create({trigger:".where__content",start:"top 80%",end:"center center",scrub:!0,animation:t}),r=new SplitText(".clothes__wrapper h2",{type:"words, chars"}),r.chars,o=r.words,t=gsap.timeline();t.from(o,{duration:.8,opacity:0,y:"-100%",transformOrigin:"bottom center",ease:"back",stagger:.15}),t.from(".clothes__header p",{y:"50%",opacity:0}),ScrollTrigger.create({trigger:".clothes__wrapper",start:"top 80%",end:"top center",scrub:!0,animation:t});gsap.timeline({repeat:-1,yoyo:!0}).to(".clothes__image img",{rotate:"15deg",duration:.8,ease:"steps(2)"});r=gsap.timeline();r.from(".clothes__image",{x:"100vw"}),ScrollTrigger.create({trigger:".clothes__image",start:"top 80%",end:"bottom 80%",scrub:!0,animation:r}),ScrollTrigger.create({trigger:".appeal__body h2",start:"top 80%",animation:gsap.from(".appeal__body h2",{opacity:0})});Array.from(document.querySelectorAll(".appeal__item")).forEach(e=>{var t=gsap.timeline(),r=e.querySelector("h3"),o=e.querySelector("p");t.from(e,{opacity:0}),t.from(r,{opacity:0}),t.from(o,{opacity:0,y:"50%"}),ScrollTrigger.create({trigger:e,start:"top 80%",animation:t})});o=[document.querySelector("#star-right"),document.querySelector("#star-left"),document.querySelector("#star-top")];gsap.set(o,{transformOrigin:"center center",scale:0}),o.forEach((e,t)=>{t=gsap.timeline({repeat:-1,repeatDelay:gsap.utils.random(.5,2),delay:gsap.utils.random(.1,1)*t});t.set(e,{scale:0}),t.to(e,{scale:1}),t.to(e,{duration:1,drawSVG:"0%",scale:gsap.utils.random(1.1,1.5)})}),gsap.set("#cup-right",{transformOrigin:"bottom center"}),gsap.to("#cup-right",{duration:1,rotate:-15,repeat:-1,yoyo:!0,yoyoEase:"slow(0.7, 0.7, false)"}),gsap.set("#cup-left",{transformOrigin:"bottom center"}),gsap.to("#cup-left",{duration:1,rotate:15,repeat:-1,yoyo:!0,yoyoEase:"slow(0.7, 0.7, false)"}),Array.from(document.querySelectorAll(".program__item")).forEach(e=>{var t=gsap.timeline(),r=e.querySelector("time"),o=e.querySelector("svg"),a=e.querySelector("p");t.from(e,{opacity:0}),t.from(r,{opacity:0,x:"-50%"}),t.from(a,{opacity:0,x:"50%"},"<"),t.from(o,{scale:0,ease:"back.out(4)"}),ScrollTrigger.create({trigger:e,start:"top 80%",animation:t})}),gsap.to(".seeyou__blob",{repeat:-1,duration:5,scale:1.3,x:"25%",rotate:0,yoyo:!0,yoyoEase:"slow(0.7, 0.7, false)"})});